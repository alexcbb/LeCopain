...
- **Update the CHANGELOG** for all enhancements and bug fixes. Include the corresponding issue number if one exists, and your GitHub username. (example: "- Fixed crash in profile view. #123 @alexcbb")
...
## Credits
Contribution mainly adapted from: [Original](https://github.com/jessesquires/.github/blob/main/CONTRIBUTING.md)